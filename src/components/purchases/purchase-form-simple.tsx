...
import { usePurchases, useCreateDraftPurchase, useUpdateDraftPurchase } from '@/hooks/use-purchases';
      ...
      if (selectedPurchase) {
        ...
        await updateDraftPurchase.mutateAsync({
          ...
          updates: {
            ...
            ...(formData.expectedDate && { effectiveDate: formData.expectedDate }),
      ...
      <div className="mb-6">
        ...
        {selectedPurchase && (
          <p className="text-gray-600 mt-1">
            Created {formatDistanceToNow(new Date(selectedPurchase.created_at), { addSuffix: true })}
          </p>
        )}
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setFormData(prev => ({ ...prev, taxes: Number(e.target.value) }))}
                className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
              />
            </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="text-center py-12 text-gray-500">
            ...
            <p className="text-sm mt-1">You'll be able to add items to this purchase order here.</p>
          </div>
        </div>
        ...
        <div className="flex justify-end space-x-3 pt-6 border-t border-gray-200">
          <Button
            type="submit"
            disabled={createDraftPurchase.isPending || updateDraftPurchase.isPending}
