    ...
    <div className="container mx-auto p-4">
      ...
      <div className="bg-gray-100 p-4 rounded-lg">
        ...
        <div className="space-y-2">
          <div>
            ...
            {supabaseConfig.hasServiceKey ? '✅ Yes' : '❌ No'}
          </div>
          <div>
          ...
          <div>
            ...
            {supabaseConfig.isProduction ? 'Production' : 'Development'}
          </div>
          <div>
      ...
      {!supabaseConfig.hasServiceKey && (
        <div className="mt-6 bg-red-100 p-4 rounded-lg">
          ...
          <p>
            The SUPABASE_SERVICE_ROLE_KEY environment variable is missing. This
            will limit functionality that requires admin access to the database.
          </p>
          <p className="mt-2">
            To fix this, add the SUPABASE_SERVICE_ROLE_KEY to your Vercel
