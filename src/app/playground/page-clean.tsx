...
function PlaygroundControls({
  ...
  const variantStyles = {
    ...
    'soft-rounded': {
      container:
        'bg-white text-gray-700 rounded-2xl shadow-md border border-gray-200',
      button:
    ...
    'zen-mode': {
      container:
        'bg-stone-100 text-stone-600 rounded-xl shadow-sm border border-stone-200',
      button:
        'hover:bg-stone-50 active:bg-stone-200 active:scale-95 rounded-lg px-3 py-2 font-medium transition-all duration-150 select-none',
      deleteButton:
        'bg-red-400 hover:bg-red-500 active:bg-red-600 active:scale-95 text-white transition-all duration-150 select-none',
      minimal: 'px-3 py-2',
      expanded: 'px-4 py-2',
    },
    'elegant-shadow': {
    ...
    'spatial-glass': {
      container:
        'bg-gradient-to-r from-purple-500/20 to-blue-500/20 backdrop-blur-md text-white rounded-2xl shadow-2xl border border-white/20 transform perspective-1000 rotateX-2',
      button:
...
export default function PlaygroundPage() {
  ...
  const variants = [
    ...
    },
    {
      key: 'soft-rounded',
      name: 'Soft Rounded',
      description: 'Clean white design with rounded corners',
    },
    {
      key: 'notion-inspired',
    ...
    },
    {
      key: 'zen-mode',
      name: 'Zen Mode',
      description: 'Calm, muted design focused on content clarity',
    },
    {
      key: 'elegant-shadow',
      name: 'Elegant Shadow',
    ...
    },
    {
      key: 'spatial-glass',
      name: 'Spatial Glass',
      description: '2025 Future: 3D spatial design with depth transforms',
    },
  ] as const;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 mt-8">
          ...
          <ul className="space-y-2 text-sm text-gray-600">
            ...
            <li>
              • <strong>7 Total Variants:</strong> Clean, consistent designs
