...
function PlaygroundControls({ state, selectedCount = 2, variant }: PlaygroundControlsProps) {
  ...
  const variantStyles = {
    ...
    'notion-inspired': {
      container: "bg-white text-gray-700 rounded-lg shadow-sm border border-gray-300",
      button: "hover:bg-gray-50 active:bg-gray-100 active:scale-95 rounded-md px-3 py-2 font-medium transition-all duration-150 select-none",
      deleteButton: "bg-red-500 hover:bg-red-600 active:bg-red-700 active:scale-95 text-white transition-all duration-150 select-none",
      minimal: "px-3 py-2",
      expanded: "px-4 py-2"
    },
    'clean-minimal': {
      container: "bg-white/80 backdrop-blur-sm text-gray-700 rounded-xl shadow-sm border border-gray-200/50",
      button: "hover:bg-gray-50 active:bg-gray-100 active:scale-95 rounded-lg px-3 py-2 font-medium transition-all duration-150 select-none",
      deleteButton: "bg-red-500 hover:bg-red-600 active:bg-red-700 active:scale-95 text-white transition-all duration-150 select-none",
      minimal: "px-3 py-2",
      expanded: "px-4 py-2"
    },
      ...
      <div className="max-w-7xl mx-auto">
            ...
            <div key={key} className="bg-white rounded-lg shadow-sm border overflow-hidden">
              ...
              <div className="relative p-6 bg-gray-100 min-h-[400px]">
                ...
                <div className="bg-white rounded-lg shadow-sm border overflow-hidden">
                  ...
                  {[
                    'Acme Corp', 'Fresh Supplies', 'Global Foods', 'Local Farm', 
                    'Premium Goods', 'Quick Supply', 'Bulk Mart', 'Specialty Co'
                  ].map((supplier) => (
                    <div key={supplier} className="grid grid-cols-5 gap-4 p-4 border-b hover:bg-gray-50">
                      <div className="font-medium">{supplier}</div>
                      <div className="text-gray-600">contact@{supplier.toLowerCase().replace(' ', '')}.com</div>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 mt-8">
          ...
          <ul className="space-y-2 text-sm text-gray-600">
            ...
            <li>• <strong>Consistent Icons:</strong> All variants now use clean Lucide React icons</li>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 mt-8">
          <h3 className="text-lg font-semibold mb-4">Modern Click Interaction Standards</h3>
          <div className="space-y-4 text-sm text-gray-600">
            <p>
              <strong>Modern SaaS Practice:</strong> Subtle click feedback is standard - scale-down (95%) on active state provides immediate tactile response without being distracting.
            </p>
            <p>
              <strong>Why Click States Matter:</strong> They bridge the gap between hover intent and action completion, providing crucial user confidence in touch interfaces.
            </p>
            <p>
              <strong>Implementation:</strong> <code className="bg-gray-100 px-2 py-1 rounded">active:scale-95 active:bg-[color] transition-all duration-150</code>
            </p>
